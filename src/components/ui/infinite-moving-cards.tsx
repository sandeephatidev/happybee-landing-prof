    ...
    return (
        ...
        >
            ...
            >
                {items.map((item, idx) => (
                    <li
                        className="w-[350px] max-w-full relative rounded-2xl flex-shrink-0 md:w-[450px] glass-panel p-8"
                        key={item.name + idx}
                    >
                        <blockquote>
                            <div
                            ...
                            <span className=" relative z-20 text-sm leading-[1.6] text-gray-300 font-normal italic">
                                {item.quote}
                            </span>
